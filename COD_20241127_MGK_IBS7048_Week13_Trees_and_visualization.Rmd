...
readRDS("/Users/minsikkim/Dropbox (Personal)/Inha/5_Lectures/2024/Advanced metagenomics/scripts/IBS7048_Advanced_metagenomics/phyloseq_examples.rds")

phyloseq_data <- readRDS("phyloseq_examples.rds")
...
stringdist(
        c("aaa", "bbc", "bbbadsfasfsafas"),
        c("aaa", "bbb", "dafafasfasfasfas"))


stringdist(
        c("Inha", "Induck", "BiologicalEngineering"), 
        c("Inha", "Inha", "Inha"))
...
stringdistmatrix(
        c("Chiiiiken","CCCCChicken","Chickkkken","Cowwww","Cooow", "CCCCow"),
        c("Chiiiiken","CCCCChicken","Chickkkken","Cowwww","Cooow", "CCCCow")
)
...
#ASV211,ASV215, ASV188,ASV75,ASV63, ASV225

sequences <- c(phyloseq_data %>%
        refseq() %>%
        .[211] %>%
        as.character() %>%
        .[[1]],
...
distancemodels <- stringdist::stringdistmatrix(text, text)
distancemodels_seq <- stringdist::stringdistmatrix(sequences, sequences)

rownames(distancemodels) <- text
rownames(distancemodels_seq) <- c("Streptococcus","Streptococcus","Staphyloccocus",
                                  "Clostridium","Clostridium","Unknown")

distancemodels
distancemodels_seq

hc <- hclust(as.dist(distancemodels))
hc_seq <- hclust(as.dist(distancemodels_seq))

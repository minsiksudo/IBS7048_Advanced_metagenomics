---
title: "COD_20241023_MGK_IBS7048_week8_introduction_to_DADA2"
author: "Minsik Kim"
date: "2024-10-23"
output:
        rmdformats::downcute:
...
```{r}
minsik_path = "Inha/5_Lectures/2023/Advanced metagenomics/IBS7048_dataset"
...
```{r}
#minsik_path
list.files(path = "Inha/5_Lectures/2023/Advanced metagenomics/IBS7048_dataset/filtered/")
...
minsik_path <- ("/mnt/4T_samsung/Dropbox/Sequencing_archive/")
taxa <- assignTaxonomy(seqtab.nochim,
                       paste0(minsik_path, "/silva_nr99_v138.1_train_set.fa.gz"),
                       multithread=TRUE)

### THIS SPECIES LEVEL ANNOTATION IS NOT ACCURATE. BE CAREFULL WHEN YOU USE IT
# taxa <- addSpecies(taxa,
#                    paste0(minsik_path, "/silva_species_assignment_v138.1.fa"))
